	...
	public static void gera() {
		JPA.withTransaction(new F.Callback0() {
			public void invoke() throws Throwable {
					...
					usuario39 = new Usuario("ivo", "ivo@mail.com", "password");
					...
					viagem1 = new Viagem(EContinente.EUROPA, "França",DATA, DATA, "Plano X", inscritosviagem1, usuario3);
					...
					viagem3 = new Viagem(EContinente.EUROPA, "Italia",DATA, DATA, "Plano X", inscritosviagem3, usuario7);
					viagem3.setInscricaoStrategy(new InscricaoLimitada());
					viagem3.setSenha("senha");
					viagem4 = new Viagem(EContinente.AMERICA_LATINA, "Brasil",DATA, DATA, "Plano X", inscritosviagem4, usuario19);
					viagem4.setInscricaoStrategy(new InscricaoLimitada());
					viagem4.setSenha("senha");
					viagem5 = new Viagem(EContinente.AMERICA_LATINA, "Chile",DATA, DATA, "Plano X", inscritosviagem5, usuario3);
					...
					viagem7 = new Viagem(EContinente.AMERICA_LATINA, "Paraguai",DATA, DATA, "Plano X", inscritosviagem7, usuario40);
					viagem7.setInscricaoStrategy(new InscricaoAberta());
					viagem8 = new Viagem(EContinente.AMERICA_DO_NORTE, "Estados Unidos",DATA, DATA, "Plano X", inscritosviagem1, usuario29);
					...
					viagem10 = new Viagem(EContinente.AMERICA_DO_NORTE, "Canadá",DATA, DATA, "Plano X", inscritosviagem3, usuario7);
					...
					viagem13 = new Viagem(EContinente.AMERICA_LATINA, "Chile",DATA, DATA, "Plano X", inscritosviagem4, usuario9);
					viagem13.setInscricaoStrategy(new InscricaoAberta());
					viagem14 = new Viagem(EContinente.AFRICA, "Angola",DATA, DATA, "Plano X", inscritosviagem1, usuario15);
					...
					viagem16 = new Viagem(EContinente.AFRICA, "Marrocos",DATA, DATA, "Plano X", inscritosviagem1, usuario18);
					...
					viagem18 = new Viagem(EContinente.AFRICA, "Congo",DATA, DATA, "Plano X", inscritosViagem9, usuario17);
					...
					viagem21 = new Viagem(EContinente.ASIA, "Iraque",DATA, DATA, "Plano X", inscritosviagem1, usuario17);
					viagem21.setInscricaoStrategy(new InscricaoAberta());
					viagem22 = new Viagem(EContinente.ASIA, "Malasia",DATA, DATA, "Plano X", inscritosviagem1, usuario27);
					viagem22.setInscricaoStrategy(new InscricaoAberta());
					viagem23 = new Viagem(EContinente.ASIA, "Tailandia",DATA, DATA, "Plano X", inscritosviagem1, usuario18);
					...
					viagem26 = new Viagem(EContinente.ASIA, "Israel",DATA, DATA, "Plano X", inscritosviagem1, usuario6);
					viagem26.setInscricaoStrategy(new InscricaoAberta());
					viagem27 = new Viagem(EContinente.EUROPA, "Grecia",DATA, DATA, "Plano X", inscritosviagem1, usuario23);
					viagem27.setInscricaoStrategy(new InscricaoAberta());
					viagem28 = new Viagem(EContinente.EUROPA, "Alemanha",DATA, DATA, "Plano X", inscritosviagem5, usuario14);
